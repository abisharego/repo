              ...
              <div class="templatemo-content-widget white-bg">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p>Get the Latest Upcomming Events in Our Campus</p>  
                  </div>
                </div>                
              </div>            
            </div>
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>2.</td>
                        <td>Dr. Chethan L S</td>
                        <td>Associate Professor</td>
                      </tr>
                      <tr>
                        <td>3.</td>
                        <td>Mr. Raghavendra K</td>
                        <td>Assistant Professor</td>
                      </tr>
                      <tr>
                        <td>4.</td>
                        <td>Mrs. Prathibha S</td>
                        <td>Assistant Professor</td>
                      </tr>
                      <tr>
                        <td>5.</td>
                        <td>Mr. Sunilkumar H R</td>
                        <td>Assistant Professor</td>
                      </tr>
                      <tr>
                        <td>6.</td>
                      ...
                      <tr>
                        <td>8.</td>
                        <td>Ms. Suchitra H L</td>
                        <td>Assistant Professor</td>
                      </tr>
                      <tr>
                        <td>9.</td>
                        <td>Mrs. Suchitha H S</td>
                        <td>Assistant Professor</td>
                      </tr>
                      <tr>
                        <td>10.</td>
                        <td>Ms. Vinutha H M</td>
                        <td>Assistant Professor</td>
                      </tr>
                      <tr>
                        <td>11.</td>
                        <td>Mr. Sandeep. K.H</td>
                        <td>Assistant Professor</td>
                      </tr>
                      <tr>
                        <td>12.</td>
